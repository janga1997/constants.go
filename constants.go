...
var Golden_ratio = (1 + _math.Sqrt(5)) / 2
...
// binary prefixes
var Kibi = _math.Pow(2, 10)
var Mebi = _math.Pow(2, 20)
var Gibi = _math.Pow(2, 30)
var Tebi = _math.Pow(2, 40)
var Pebi = _math.Pow(2, 50)
var Exbi = _math.Pow(2, 60)
var Zebi = _math.Pow(2, 70)
var Yobi = _math.Pow(2, 80)
...
var M_u, U = Atomic_mass, Atomic_mass
...
var Hectare = 1e4
var Acre = 43560 * _math.Pow(Foot, 2)

// volume in meter<<3
var Litre, Liter = 1e-3, 1e-3
var Gallon, Gallon_US = 231 * _math.Pow(Inch, 3), 231 * _math.Pow(Inch, 3) // US
// pint = gallon_US / 8
var Fluid_ounce, Fluid_ounce_US = Gallon_US / 128, Gallon_US / 128
var Bbl, Barrel = 42 * Gallon_US, 42 * Gallon_US // for oil
...
func convert_temperature(val float64, old_scale string, new_scale string) float64 {
...
func lambda2nu(lambda_ float64) float64 {
	return C / lambda_
}

func nu2lambda(nu_ float64) float64 {
	return C / nu_
}
